...
from app.services import coins, wallets, whales_ingest
...
def start_scheduler():
    ...
    sched.add_job(
        wallets.refresh_wallet_tracker, "interval", seconds=30, id="wallet-tracker", jitter=5
    )
    sched.add_job(
        wallets.refresh_wallet_overview, "interval", seconds=600, id="wallet-overview", jitter=30
    )
